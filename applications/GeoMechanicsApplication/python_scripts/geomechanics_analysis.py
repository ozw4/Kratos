...
class GeoMechanicsAnalysis(AnalysisStage):
    ...
    def __init__(self,model,parameters):
        ...
        super(GeoMechanicsAnalysis,self).__init__(model,parameters)
    ...
    def _CreateProcesses(self, parameter_name, initialization_order):
        ...
        """
        list_of_processes = super(GeoMechanicsAnalysis, self)._CreateProcesses(parameter_name, initialization_order)
    ...
    def Finalize(self):
        super(GeoMechanicsAnalysis,self).Finalize()
