...
proc kipt::LoadSourceFiles {dir} {
    ...
    # For Wizard library
    lappend lib_paths [file join $dir scripts libs wizard]
    lappend lib_filenames {snitwiz.tcl}

    # For wcb library
    lappend lib_paths [file join $dir scripts libs wcb]
	...
	# Spreaddem wizard
	lappend lib_paths [file join $dir wizards spreaddem]
	lappend lib_filenames {spreaddem_body.tcl}
