...
proc ::wkcf::TranslateToBinary {yes_no_var} {
    if {($yes_no_var eq "Yes") || ($yes_no_var eq "Active") || ($yes_no_var eq "Activate")} {
	return 1
    } else {
	return 0}
}
...
proc ::wkcf::WriteExplicitSolverVariables {} {
    ...
    # Integration Scheme
    set cxpath "$rootid//c.DEM-SolutionStrategy//i.DEM-TimeIntegrationScheme"
    set IntegScheme [::xmlutils::setXml $cxpath $cproperty]

    puts $fileid "IntegrationScheme                = \"$IntegScheme\""
